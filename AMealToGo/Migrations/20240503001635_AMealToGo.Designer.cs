...
namespace AMealToGo.Migrations
{
    ...
    [Migration("20240503001635_AMealToGo")]
    partial class AMealToGo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AMeelToGo.models.Order", b =>
                {
                    ...
                    b.Property<int>("custemerCustomerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AMeelToGo.models.Order", b =>
                {
                    ...
                    b.HasOne("AMeelToGo.models.Customer", "custemer")
                        .WithMany()
                        .HasForeignKey("custemerCustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
