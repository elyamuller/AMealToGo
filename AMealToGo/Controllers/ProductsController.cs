...
namespace AMealToGo.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ProductsController(MealToGoDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Product>> PostProduct(Product product)
        {
            ...
            {
                return BadRequest("this product " + product.Name + " already exists");
            }
        }
        ...
        {
            return _context.Product.Any(a => a.Name == Name);
        }
    }
}
